...
export const metadata: Metadata = {
  ...
  description:
    "The terms that govern your use of Ringo's AI voice ordering platform.",
};
  ...
  return (
    <LegalLayout title="Terms of Service" effectiveDate="April 14, 2026">
      <p>
        ...
        agreement between <strong>Ringo AI, Inc.</strong> (&ldquo;Ringo,&rdquo;
        ...
        for, accessing, or using the Ringo platform at{" "}
        <a href="https://useringo.ai">useringo.ai</a> (the
        &ldquo;Service&rdquo;), you agree to these Terms.
      </p>

      <h2>1. The Service</h2>
      <p>
        Ringo provides an AI voice agent that answers inbound phone calls for
      ...
      <ul>
        <li>
          Ringo is offered on a monthly or annual subscription. Current pricing
          appears on the Ringo website or in your order form.
        </li>
        <li>
      ...
      <p>
        ...
        order data (&ldquo;Customer Data&rdquo;). You grant Ringo a
      ...
      <ul>
        ...
        <li>Resell or white-label the Service without a written agreement with Ringo.</li>
      ...
      <p>
        Ringo connects to third-party services you authorize (for example,
        ...
        terms. Ringo is not responsible for outages, errors, or changes in
      ...
      <p>
        Ringo and its licensors own the Service, including all software,
      ...
      <p>
        ...
        emailing <a href="mailto:hello@useringo.ai">hello@useringo.ai</a>.
      ...
      <p>
        ...
        AVAILABLE.&rdquo; TO THE MAXIMUM EXTENT PERMITTED BY LAW, RINGO
      ...
      <p>
        ...
        YOU PAID TO RINGO IN THE TWELVE (12) MONTHS PRECEDING THE EVENT GIVING
        RISE TO THE CLAIM.
      </p>

      <h2>14. Indemnification</h2>
      <p>
        You will defend, indemnify, and hold harmless Ringo from any
      ...
      <p>
        These Terms are the entire agreement between you and Ringo about the
      ...
      <p>
        ...
        Email: <a href="mailto:hello@useringo.ai">hello@useringo.ai</a>
      </p>
    </LegalLayout>
  );
}
